...
{
    /// <summary>
    /// Adds wrappers arounds the Get, Remove and Exists methods for callbacks with 1 to 15 arguments.
    /// </summary>
    public partial class CacheManager
    {
        // Filler object for wrapping calls with less than 16 arguments
        ...
        /// <summary>
        /// Gets an item from the cache. Loads the item and stores it in cache if it is not available.
        /// </summary>
        ...
        /// <summary>
        /// Removes an existing item from the cache.
        /// </summary>
